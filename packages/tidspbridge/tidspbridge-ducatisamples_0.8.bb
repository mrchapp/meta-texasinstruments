...
CCASE_SPEC = "%\
	      element /vobs/WTSD_MultiCoreSW/Ducati/Bridge/... BRIDGE-DUCATI_RLS_${PV}-P1%\
...
ENV_VAR = "DEPOT=${DEPOT} \
	   ...
	   DD_XDCDIR=${XDC_DIR} \
	   DD_XDC_OPT=DD_XDCDIR=${XDC_DIR} DD_XDCOPTIONS="XDCOPTIONS=v XDCBUILDCFG=${S}/config.bld XDCPATH=${SABIOS_DIR}\;${FC_DIR}/fctools/packages\;${FC_DIR}/packages\;${S}/bdsptools/packages\;${CGTARM_DIR}/packages\;${S} COFF_BLD=true" \
"
