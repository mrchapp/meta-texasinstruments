...
DIRAC_PATHFETCH = "/data/omapts/linux/dsp-tc/framework_components_3_00_00_30"
DIRAC_PATHCOMPONENT = "framework_components_3_00_00_30"
...
do_stage() {
	chmod -R +w ${S}/*
	install -d ${STAGING_BINDIR}/dspbridge/tools/framework_components_3_00_00_30
