...
do_install_cleanup() {
	...
	${@base_contains("DISTRO_FEATURES", "testpatterns", "mv ${D}${bindir}/audio_decoder.ra_* ${D}/usr/omx/patterns", "", d)}
	${@base_contains("DISTRO_FEATURES", "testpatterns", "mv ${D}${bindir}/cook*.rm ${D}/usr/omx/patterns", "", d)}
}
