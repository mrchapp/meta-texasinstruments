...
CCASE_PATHFETCH = "/vobs/wtbu/CSSD_Linux_Releases/3430/Linux_23.I3.x/ittiam-sw/tisocketnode-h264decitt-${PV}.tar.gz"
...
do_unpack_ccase_append() {
	cd ${S}
	tar zxf tisocketnode-h264decitt-${PV}.tar.gz
	mv vobs/wtbu/OMAPSW_DSP/video .
	rm -fr vobs
	rm -fr tisocketnode-h264decitt-${PV}.tar.gz
}
