...
CCASE_PATHFETCH = "/vobs/wtbu/CSSD_Linux_Releases/3430/Linux_23.I3.x/ittiam-sw/tisocketnode-mpeg4decitt-codec-3.7.tar.gz"
...
do_unpack_ccase_append() {
	cd ${S}
	tar zxf tisocketnode-mpeg4decitt-codec-3.7.tar.gz
	mv vobs/wtbu/CSSD_MM_Releases/Codecs/video/mpeg4_dec_ittiam/c64x/mm_tiicodecs/ITT_MPEG4_DEC.zip .
	rm -fr vobs
	rm -fr tisocketnode-mpeg4decitt-codec-3.7.tar.gz
}
