...
CCASE_PATHFETCH = "/vobs/wtbu/CSSD_Linux_Releases/3430/Linux_23.I3.x/ittiam-sw/tisocketnode-mpeg4encitt-20100223.tar.gz"
...
do_unpack_ccase_append() {
	cd ${S}
	tar zxf tisocketnode-mpeg4encitt-20100223.tar.gz
	mv vobs/wtbu/OMAPSW_DSP/video .
	rm -fr vobs
	rm -fr tisocketnode-mpeg4encitt-20100223.tar.gz
}
